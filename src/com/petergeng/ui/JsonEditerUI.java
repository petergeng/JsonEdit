...
System.out.println("123");
        DefaultMutableTreeNode node = (DefaultMutableTreeNode) jTree1.getLastSelectedPathComponent();  //获得右键选中的节点
 	if (evt.getSource() == jMenuItem2) {
            ((DefaultTreeModel) jTree1.getModel()).insertNodeInto(new DefaultMutableTreeNode("Test"), node, node.getChildCount());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JsonEditerUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
